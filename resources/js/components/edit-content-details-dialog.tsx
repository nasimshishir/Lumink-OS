...
export function EditContentDetailsDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            <DialogContent className="max-w-2xl overflow-y-auto sm:max-h-[85vh]">
                <DialogHeader>
                    <DialogTitle>Edit Brief & details</DialogTitle>
                    <DialogDescription>
                        Update the production and creative details for this
                        content.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="grid gap-6 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Textarea
                                ...
                                onChange={(e) =>
                                    form.setData('shoot_notes', e.target.value)
                                }
